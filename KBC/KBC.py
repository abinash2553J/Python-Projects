questions = [
    ...
    ["What is the smallest country in the world?", "San Marino", "Vatican City", "Monaco", "Liechtenstein", 2],3
    ["Which is the 3rd largest economy in the world?", "Germany", "India", "USA", "Russia", 1]
]

prizes = [100000, 320000, 400000, 450000,  500000, 1000000, 2000000, 3000000, 4000000, 5000000, 6000000, 7000000]
